        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="/admin_course">Courses</a>
                </div>
            <li class="nav-item">
        ...
        <table class="table table-bordered table-striped">
            ...
            @foreach($row as $row)
                <tr>
                    ...
                    <td>
                        {{--                        <img src="admin/fetch_image/{{ $row->id }}" class="img-thumbnail" width="75" alt="">--}}
                        <img style="height: 10%" src="{{ asset('uploads/appsetting/' . $row->image) }}" alt="" >
{{--                        <video width="320" height="240" controls>--}}
{{--                            <source src="{{URL::asset("/uploads/appsetting/$row->image")}}" type="video/mp4">--}}
...
{{--                        </video>--}}
                    ...
                    <td>
                                                <video width="150" height="150" controls>
                                                    <source src="{{URL::asset("/uploads/appsetting/$row->video")}}" type="video/mp4">
                                                </video>
                    </td>
                    <td>
                        <a href="{{route('admin_courses_edit', $row->id)}}">
                    ...
                    <td>
                        <form action="{{route('admin_courses_delete', $row->id)}}" method="post">
                            @csrf
                            @method('delete')
